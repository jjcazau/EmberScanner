...
import { EmberScannerNativeComponent } from './native.component';
...
@NgModule({
    declarations: [
        ...
        EmberScannerNativeComponent,
    ],
    exports: [EmberScannerNativeComponent],
    imports: [AppSharedModule],
})
export class EmberScannerNativeModule { }
