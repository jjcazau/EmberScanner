...
import { Config, EmberScannerAdminService, System } from '../../admin.service';

@Component({
    selector: 'ember-scanner-admin-import-talkgroups',
    styleUrls: ['./import-talkgroups.component.scss'],
    templateUrl: './import-talkgroups.component.html',
    standalone: false
})
export class EmberScannerAdminImportTalkgroupsComponent implements OnInit {
