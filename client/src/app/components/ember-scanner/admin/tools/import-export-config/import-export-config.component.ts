...
import { Config, EmberScannerAdminService } from '../../admin.service';
import packageInfo from '../../../../../../../package.json';

@Component({
    selector: 'ember-scanner-admin-import-export-config',
    styleUrls: ['./import-export-config.component.scss'],
    templateUrl: './import-export-config.component.html',
    standalone: false
})
export class EmberScannerAdminImportExportConfigComponent {
    ...
    async export(): Promise<void> {
        ...
        const fileName = `ember-scanner-${this.version}.config.json`;
