...
@Component({
    ...
    selector: 'ember-scanner-admin-systems-selection',
    styleUrls: ['./select.component.scss'],
    templateUrl: './select.component.html',
    standalone: false
})
export class EmberScannerAdminSystemsSelectComponent implements OnDestroy {
    indeterminate = {
        everything: false,
        groups: [] as boolean[],
        systems: [] as boolean[],
    ...
    constructor(
        ...
        private matDialogRef: MatDialogRef<EmberScannerAdminSystemsSelectComponent>,
