...
@Component({
    selector: 'ember-scanner-admin-systems',
    templateUrl: './systems.component.html',
    standalone: false,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class EmberScannerAdminSystemsComponent implements OnDestroy {
    ...
    constructor(private adminService: EmberScannerAdminService, private cd: ChangeDetectorRef) { }
