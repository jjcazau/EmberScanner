...
import { Log, LogsQuery, LogsQueryOptions, EmberScannerAdminService } from '../admin.service';

@Component({
    selector: 'ember-scanner-admin-logs',
    styleUrls: ['./logs.component.scss'],
    templateUrl: './logs.component.html',
    standalone: false
})
export class EmberScannerAdminLogsComponent {
    form: FormGroup;
    ...
    constructor(private adminService: EmberScannerAdminService, private ngFormBuilder: FormBuilder) {
