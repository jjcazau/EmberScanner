...
Here is an example of a web page that embeds an Ember Scanner instance in an `<iframe ...>` with responsive content.

You can use these files as a starter kit and update them as you wish.

> Remember to replace the `<iframe src="http://localhost:3000">` value with the address of your Ember Scanner instance.